...
<head>
    ...
    <title>Admin Orders - DUMBLEDORE BOUTIQUE</title>
...
<body>
    ...
    // Get all orders
    $result = $conn->query("SELECT o.*, u.fullname, u.email FROM orders o JOIN users u ON o.user_id = u.user_id ORDER BY o.created_at DESC");
    $orders = [];
                            ...
                            <table class="table admin-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge" style="background: <?php echo $order['order_status'] == 'delivered' ? '#51cf66' : '#ffc107'; ?>;">
